...
public class DiscoverGamesGridController {
	...
	public void setGamesData(List<Game> popularGames, List<Game> newGames, List<Game> recommendedGames,
		...
		// Guardamos el estado original de cada categoría
		...
		// Guardamos el estado original de todos los juegos
	...
	public void showSearchResults(List<Game> searchResults) {
		// Guardamos el estado actual antes de aplicar la búsqueda
	...
	public void showFilteredResults(List<Game> filteredGames) {
		// Guardamos el estado actual antes de aplicar los filtros
		preFilterState.clear();
		preFilterState.addAll(currentDisplayedGames);
		...
		// Limpiamos resultados anteriores y mostrar los juegos filtrados
		VBoxContainer.getChildren().clear();
	...
	/**
	 * Obtiene todos los juegos que hay en pantalla
	 * 
	 * @return Lista de juegos en pantalla
	 */
	...
	/**
	 * Restaura la página a como esta en un inicio
	 */
	public void restoreOriginalState() {
		// Restauramos el estado anterior a la búsqueda o filtrado
		currentDisplayedGames.clear();
	...
	private void showSearchResult(List<Game> searchResults) {
		...
		if (!searchResults.isEmpty()) {
			// Dividimos los resultados en grupos de 5
